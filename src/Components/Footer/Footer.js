      ...
      <div className="footer-container">
        <div className="footer-content">
          <div className="footer-brand">
            <img className="footer-logo" src={Logo} alt="2024" />

            <p className="footer-description">
              Your gateway to practical learning and professional growth.
              PractyWiz connects aspiring talents with industry mentors,
              facilitating real-world experiences through internships, case
              studies, and meaningful alumni connections.
            </p>
              ...
              <ul className="contact-info">
                <li>
                  <a href="#">
                    ...
                    <span>wecare@practywiz.com</span>
                  </a>
                </li>
                <li>
                  <a href="#">
                ...
                {/* <li>
                  <address>
                    ...
                    <span>213 Lane, London, United Kingdom</span>
                  </address>
                </li> */}
              </ul>
            </div>
