...
const QuestionShow = ({ data }) => {
  ...
  const totalMarks = allQuestions
    .filter(q => q.category !== 'research') // Exclude research-based questions
                        ...
                        <div>
                          ...
                          <div className="question-show-options-list">
                            {q.options.map((option, optIndex) => (
                              <div
                                key={optIndex}
                                className="question-show-option question-show-option-normal"

                              >
                                <span className="question-show-option-letter">
                                  {String.fromCharCode(65 + optIndex)}
                                </span>
                                <span className="question-show-option-text">{option}</span>
                          ...
                          <div>
                            ...
                            <div className="question-show-options-list">
                              {q.options.map((option, optIndex) => (
                                <div
                                  key={optIndex}
                                  className={`question-show-option ${option.trim() === q.answer.trim()
