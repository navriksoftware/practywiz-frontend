...
// import "../DashboardCSS/SingleStudentAssessmentPage1.css"; // Assuming you have a CSS file for styling
...
const SingleStudentAssessmentPage = () => {
  ...
  const analysisDetails1 = parseJSONField(data.mentee_result_analysis_details);
  const factDetails1 = parseJSONField(data.mentee_result_fact_details);

  const factQuestionsCorrect = factDetails1.filter(q => q.obtainedMark === q.maxMark).length;
  const analysisQuestionsCorrect = analysisDetails1.questions.filter(q => parseInt(q.obtainedMark) === q.maxMark).length;

  const factPercentage = Math.round((factQuestionsCorrect / factDetails1.length) * 100);
  const analysisPercentage = Math.round((analysisQuestionsCorrect / analysisDetails1.questions.length) * 100);
  ...
  const CircularProgress = ({ percentage, correctAnswers, totalQuestions, label, color }) => {
    ...
    return (
      <div className="single-student-assessment-page-circular-progress">
        <svg width="200" height="200" className="single-student-assessment-page-progress-svg">
          <circle
            cx="100"
            cy="100"
            r={radius}
  ...
  return (
    <main className="single-student-assessment-page-container">
      ...
      <div className="single-student-assessment-page-columns">

        <div className="single-student-assessment-page-left"> {/* Header */}
          {/* Score Section */}
          <div className="single-student-assessment-page__score-section">
            <div className="single-student-assessment-page-Row"><div className="single-student-assessment-page__main-score">
          ...
          <div className="single-student-assessment-page__info-card">
            <div className="single-student-assessment-page__info-row">
              <div className="single-student-assessment-page__info-Sub-row">
        ...
        <div className="single-student-assessment-page-Right">{/* Question 1 fact Base */}
