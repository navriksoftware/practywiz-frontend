...
// const AddBulkStudents = ({ setshowAddBulkStudent, instituteName }) => {
//   const [columns, setColumns] = useState([]);
//   const [data, setData] = useState([]);
//   const [error, setError] = useState(null);
//   const [file, setFile] = useState(null);
...
//     } catch (err) {
//       setIsLoading(false);
//       setError(err.response?.data?.error || "Failed to upload students. Please try again.");
...
//     <div className="AddSingleStudentBackdrop">
//       <div className="addbulkupload-container AddBulkStudentModal">
//         <div className="AddSingleStudent-CloseBtn" onClick={() => setshowAddBulkStudent(false)}>
...
//                 Please select the file to import students
//               </label>
//               <a href="#" onClick={downloadTemplate} className="addbulkupload-template-link">
//                 Download template
//               </a>
//             </div>
...
//                 {uploadResult.registered && uploadResult.registered.length > 0 && (
//                   <div className="addbulkupload-table-container">
